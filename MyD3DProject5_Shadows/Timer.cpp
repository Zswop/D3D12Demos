...
Timer::Timer()
{
	...
	elapsedD = static_cast<double>(elapsed);
	elapsedF = static_cast<float>(elapsedD);
	...
	elapsedMicrosecondsF = static_cast<float>(elapsedMicrosecondsD);
	...
	deltaMillisecondsD = 0;
	deltaMicroseconds = 0;
	deltaMicrosecondsF = 0;
	deltaMicrosecondsD = 0;
}
...
void Timer::Update()
{
	...
	deltaD = static_cast<double>(delta);
	deltaF = static_cast<float>(deltaD);
