...
void Model::GenerateTestScene()
{
	...
	meshMaterials[0].TextureNames[uint64(MaterialTextures::Albedo)] = L"Default.dds";
	meshMaterials[0].TextureNames[uint64(MaterialTextures::Normal)] = L"DefaultNormalMap.dds";
	
	meshMaterials[1].TextureNames[uint64(MaterialTextures::Albedo)] = L"Sponza_Bricks_a_Albedo.png";
	meshMaterials[1].TextureNames[uint64(MaterialTextures::Normal)] = L"Sponza_Bricks_a_Normal.png";
	meshMaterials[1].TextureNames[uint64(MaterialTextures::Roughness)] = L"Sponza_Bricks_a_Roughness.png";

	meshMaterials[2].TextureNames[uint64(MaterialTextures::Albedo)] = L"Sponza_Floor_diffuse.png";
	meshMaterials[2].TextureNames[uint64(MaterialTextures::Normal)] = L"Sponza_Floor_normal.png";
	meshMaterials[2].TextureNames[uint64(MaterialTextures::Roughness)] = L"Sponza_Floor_roughness.png";
	...
	meshes.Init(3);
	meshes[0].InitPlane(Float3(0.0f, 0.0f, 0.0f), Float2(100.0f), Quaternion(), 2, vertices.Data(), indices.Data());
