...
static void CompileShader(const wchar* path, const char* functionName, ShaderType type,
	const D3D_SHADER_MACRO* defines, GrowableList<wstring>& filePaths, Array<uint8>& byteCode)
{
...
{
	return CompileFromFile(path, functionName, ShaderType::Vertex, compileOptions);
}
...
PixelShaderPtr CompilePSFromFile(const wchar* path,
	...
	const CompileOptions& compileOptions)
{
	return CompileFromFile(path, functionName, ShaderType::Pixel, compileOptions);
}
...
GeometryShaderPtr CompileGSFromFile(const wchar* path,
	...
	const CompileOptions& compileOptions)
{
	return CompileFromFile(path, functionName, ShaderType::Geometry, compileOptions);
}
...
HullShaderPtr CompileHSFromFile(const wchar* path,
	...
	const CompileOptions& compileOptions)
{
	return CompileFromFile(path, functionName, ShaderType::Hull, compileOptions);
}
...
DomainShaderPtr CompileDSFromFile(const wchar* path,
	...
	const CompileOptions& compileOptions)
{
	return CompileFromFile(path, functionName, ShaderType::Domain, compileOptions);
}
...
ComputeShaderPtr CompileCSFromFile(const wchar* path,
	...
	const CompileOptions& compileOptions)
{
	return CompileFromFile(path, functionName, ShaderType::Compute, compileOptions);
}
