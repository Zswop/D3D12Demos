...
void Create2DTexture(Texture& texture, const TextureData<UByteN4>& textureData, bool srgb = false);
...
void GetTextureData(const Texture& texture, TextureData<UByteN4>& textureData, bool srgb = false);
