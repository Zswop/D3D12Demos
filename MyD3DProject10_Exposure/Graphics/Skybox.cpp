...
{
	const std::wstring shaderPath = L"Shaders\\Skybox.hlsl";
...
void Skybox::RenderSky(ID3D12GraphicsCommandList* cmdList, const Float4x4& view, const Float4x4& projection, 
	const SkyCache& skyCache, const Float3& scale, bool enableSun)
{
	PIXMarker mark(cmdList, "Skybox Render Sky");
