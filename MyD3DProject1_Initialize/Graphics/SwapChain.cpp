...
void SwapChain::CheckForSuitableOuput()
{
}
...
void SwapChain::Reset()
{
	...
	DXCall(swapChain->SetFullscreenState(fullScreen, nullptr));
...
void SwapChain::BeginFrame()
{
	...
	DX12::TransitionResource(DX12::CmdList, backBuffers[backBufferIdx].Texture.Resource,
